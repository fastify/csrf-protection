...
| `csrfOpts` |  The csrf options. See  [csrf](https://github.com/fastify/csrf).     |
...
It is recommended to provide a custom `getToken` function for security and performance reasons.
